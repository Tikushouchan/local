...
def build_tiles(area_code, all_areas, parent=None):
    stack = [(area_code, parent)]
    tiles = {}

    while stack:
        current_code, parent_tile = stack.pop()
...
def main(page: ft.Page):
    ...
    # デバッグのためにタイル名を表示
    for t in area_tiles:
        print(t.controls[0].controls[0].value)
